...
const coupons: Coupon[] = [
  ...
  { id: "coupon-4", title: "Double points Tuesday", description: "Earn double points on Tuesday purchases.", expiresAt: "2026-08-21", state: "available" },
  { id: "coupon-5", title: "Free topping", description: "Add one premium topping at no cost.", expiresAt: "2026-08-28", state: "available" },
]
